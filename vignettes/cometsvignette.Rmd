...
To display the heatmap of the resulting correlation matix, use the showheatmap function.
```{r}
COMETS::showHeatmap(excorrdata)
```
To display the hierarchical clustering of the resulting correlation matix, use the showHClust function. Requires at least 2 rows and 2 columns in the correlation matrix
```{r}
exmodeldata<-COMETS::getModelData(exmetabdata,modelspec = "Interactive",colvars = "age bmi")
excorrdata  <- COMETS::getCorr(exmodeldata,exmetabdata,"DPP")
