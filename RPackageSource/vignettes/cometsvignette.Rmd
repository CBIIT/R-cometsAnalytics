...
This vignette demonstrates using the COMETS R package from the command line. 
See the [**tutorial**](https://cbiit.github.io/R-cometsAnalytics/Tutorial/docs/) for using COMETS from the GUI. 
Documentation of the COMETS R package can be found here [**manual**](https://github.com/CBIIT/R-cometsAnalytics/blob/gh-pages/COMETS-manual.pdf).
...
Complete documentation of the various sheets can be found in the package documentation.
